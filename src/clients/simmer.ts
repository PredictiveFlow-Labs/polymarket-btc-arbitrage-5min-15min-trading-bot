...
export class SimmerClient implements ExecutionClient {
  ...
  async importMarket(slug: string): Promise<void> {
    const url = `https://polymarket.com/event/${slug}`;
    this.log.info({ slug }, 'importing market');
    await this.http.post<SimmerMarket>('/api/sdk/markets/import', {
      polymarket_url: url,
    });
  }
